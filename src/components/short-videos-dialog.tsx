    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="video">视频文件 * (支持 mp4, webm, mov 格式，最大 100MB)</Label>
            <Input
              id="video"
              type="file"
            ...
            {videoFile && (
              <p className="text-xs text-muted-foreground">
                ...
                {videoFile.size > 100 * 1024 * 1024 && (
                  <span className="text-destructive ml-2">⚠️ 文件超过 100MB 限制</span>
                )}
              </p>
            )}
          </div>
          <div className="grid gap-2">
            <Label htmlFor="thumbnail">视频封面图片 (推荐，最大 10MB)</Label>
            <Input
              id="thumbnail"
              type="file"
              accept="image/*"
            ...
            {thumbnailFile && (
              <p className="text-xs text-muted-foreground">
                ...
                {thumbnailFile.size > 10 * 1024 * 1024 && (
                  <span className="text-destructive ml-2">⚠️ 文件超过 10MB 限制</span>
                )}
              </p>
            )}
          </div>
